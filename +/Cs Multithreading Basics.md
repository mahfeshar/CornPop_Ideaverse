...
- لما **Thread** يدخل على الكود المحمي بالـLock، **Thread** تاني مش هيقدر يدخل لحد ما الأول يخلص.
...
الـ**Multithreading** مش بيزود سرعة البرنامج، لكنه بيخلي البرنامج أكتر استجابة. يعني بدل ما الـUser يحس إن البرنامج هنج لما يدوس على زرار، بيقدر يتعامل معاه عادي والعمليات الطويلة شغالة في الخلفية. بس خد بالك، استخدام عدد كبير من الـ**Threads** ممكن يقلل أداء البرنامج بسبب الـ**Context Switching** اللي بيحصل بين الـ**Threads**.

في النهاية، لازم تفهم الأساسيات دي عشان لما تدخل في المواضيع المتقدمة زي **TPL** أو **Task Library**، تكون عارف إيه اللي بيحصل تحت الغطاء. وإن شاء الله في الفيديوهات الجاية هنتكلم عن المواضيع دي بشكل أعمق.
