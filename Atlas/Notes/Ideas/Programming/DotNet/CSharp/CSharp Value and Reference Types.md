...
[[CSharp Data Types#Bulit-in types table (Primitive)]]
...
- مش بتسمح بال *null* 
  ممكن تاخد قيمة [[CSharp Null]] عن طريق ال [[CSharp Null#|Nullable Types]]
### access garbage
...
- لو عايز تحجزله مكان بقا بنستخدم كلمة `new` وبعدها هيبدأ **يخزن الداتا فعلًا** بس بيخزنها في ال *Heap*
  ...
  مثال: لما باجي أعمل Array جديدة [[CSharp Arrays#Create an Array|Create Array]]
